...
int main(int argc, char **argv) {
  ...
  std::cout << GridLogMessage << "=== Path (a): plain CG (n=" << n_solves << " solves) ===" << std::endl;
  ...
  std::cout << GridLogMessage << "  CG  per-solve: " << (cg_total_secs / n_solves)  << " s, " << (total_cg_iters / n_solves) << " iters" << std::endl;
  std::cout << GridLogMessage << "  MG  per-solve: " << (mg_solve_secs / n_solves)  << " s, " << (total_mg_iters / n_solves) << " iters (no setup)" << std::endl;
  ...
  std::cout << GridLogMessage << "  per-solve speedup (CG/MG-amortized) = " << per_solve_speedup << "x" << std::endl;
