// TXQCD Möbius EO rational pseudofermion FD force test.
// Mirrors Test_txqcd_mobius_rational_force.cc but uses the EO-preconditioned
// (Schur) rational action TXQCDMobiusRationalEOAction.
